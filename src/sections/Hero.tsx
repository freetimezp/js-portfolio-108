...
export const Hero = () => {
  return (
    ...
    >
      ...
      <div className="absolute h-[344px] md:h-[580px] w-[344px] md:w-[580px] border border-white rounded-full top-1/2 left-1/2 
      ...
      <div className="absolute h-[444px] md:h-[780px] w-[444px] md:w-[780px] rounded-full border 
        border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed"></div>

      <div className="absolute h-[544px] md:h-[980px] w-[544px] md:w-[980px] rounded-full border 
