        ...
        <div className="overflow-hidden mt-10
          ...
          <div className="flex gap-5">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="border border-white/15 p-6 md:p-10 rounded-xl
                ...
                <div className="flex items-center gap-3 mt-5">
                  <div className="relative after:content-[''] after:absolute after:inset-0
                ...
                before:border-white/30 before:z-10 before:rounded-lg">
                    <Image
                      ...
                      alt="avatar"
                      className="w-11 h-11 rounded-lg grayscale border border-white/30"
                    />
                  </div>
